...
SR_CTRL
Text Label 3675 8125 0    50   ~ 0
24V
Text Label 3675 8525 0    50   ~ 0
GLV_RTN
Text Label 5975 8050 2    50   ~ 0
5V_ISO
Text Label 5975 8350 2    50   ~ 0
3.3V_ISO
...
U 1 1 5FB8CE84
P 3725 10450
F 0 "D5" V 3764 10332 50  0000 R CNN
F 1 "LED" V 3673 10332 50  0000 R CNN
F 2 "CarMan General Footprints:VAOL-S8GT4" H 3725 10450 50  0001 C CNN
F 3 "~" H 3725 10450 50  0001 C CNN
	1    3725 10450
	0    -1   -1   0   
$EndComp
Wire Wire Line
	3725 10600 3725 10800
Text Label 3825 10950 2    50   ~ 0
GLV_RTN
$Comp
L Device:R R15
U 1 1 5FB8CE91
P 3725 10150
F 0 "R15" H 3795 10196 50  0000 L CNN
F 1 "10k" H 3795 10105 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 3655 10150 50  0001 C CNN
F 3 "~" H 3725 10150 50  0001 C CNN
	1    3725 10150
	1    0    0    -1  
$EndComp
Wire Wire Line
	3725 10000 3725 9900
Text Label 4175 9900 2    50   ~ 0
5V_NON_ISO
$Comp
L Device:LED D3
U 1 1 5FBB7D0B
P 3200 10450
F 0 "D3" V 3239 10332 50  0000 R CNN
F 1 "LED" V 3148 10332 50  0000 R CNN
F 2 "CarMan General Footprints:VAOL-S8GT4" H 3200 10450 50  0001 C CNN
...
U 1 1 5FBB7D14
P 3200 10150
F 0 "R13" H 3270 10196 50  0000 L CNN
F 1 "10k" H 3270 10105 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 3130 10150 50  0001 C CNN
...
Wire Notes Line
	4425 11100 2800 11100
Wire Notes Line
	2800 9450 2800 11100
Wire Notes Line
...
$Sheet
S 4200 7850 1250 1025
U 5FAD1CB8
F0 "LogicPower" 50
F1 "LogicPower.sch" 50
F2 "24V" I L 4200 8125 50 
F3 "GLV_RTN" I L 4200 8525 50 
F4 "5V_ISO" O R 5450 8050 50 
F5 "3.3V_ISO" O R 5450 8350 50 
F6 "ISO_RTN" O R 5450 8675 50 
$EndSheet
Wire Notes Line
...
Wire Wire Line
	3475 10800 3725 10800
Wire Wire Line
	3475 10800 3475 10950
Wire Wire Line
	3725 9900 4175 9900
Wire Wire Line
	3200 9900 3350 9900
...
U 1 1 6074CAEC
P 1400 8675
F 0 "D?" V 1439 8557 50  0000 R CNN
...
U 1 1 6074CAF2
P 2050 8675
F 0 "D?" V 2089 8557 50  0000 R CNN
...
U 1 1 6074CAFB
P 1400 8375
F 0 "R?" H 1470 8421 50  0000 L CNN
...
U 1 1 6074CB01
P 2050 8375
F 0 "R?" H 2120 8421 50  0000 L CNN
...
U 1 1 6074CB0B
P 750 8675
F 0 "D?" V 789 8557 50  0000 R CNN
...
U 1 1 6074CB12
P 750 8375
F 0 "R?" H 820 8421 50  0000 L CNN
...
Wire Wire Line
	750  8225 750  8125
Text Label 750  8125 0    50   ~ 0
STATE_OUT_1
Wire Wire Line
	1400 9025 2050 9025
Text Notes 950  7825 0    79   ~ 0
Drive State LEDs
Wire Wire Line
	750  9025 1400 9025
Wire Wire Line
...
Wire Wire Line
	7400 4075 6725 4075
Text Label 1400 8125 0    50   ~ 0
STATE_OUT_2
Text Label 2050 8125 0    50   ~ 0
STATE_OUT_3
NoConn ~ 3075 2775
NoConn ~ 3075 2675
NoConn ~ 3075 2575
