...
U 2 1 616E5BE5
P 3625 5200
F 0 "U40" H 3625 5200 50  0000 C CNN
F 1 "MCP6004" H 3825 5075 50  0000 C CNN
F 2 "TSI_Rev_2021_Footprint_Lib:SOIC127P600X175-14N" H 3575 5300 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74hc00" H 3675 5400 50  0001 C CNN
	2    3625 5200
	1    0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 616E5BDE
P 3625 4275
F 0 "U40" H 3675 4275 50  0000 C CNN
F 1 "MCP6004" H 3775 4425 50  0000 C CNN
F 2 "TSI_Rev_2021_Footprint_Lib:SOIC127P600X175-14N" H 3575 4375 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74hc00" H 3675 4475 50  0001 C CNN
	1    3625 4275
	1    0    0    -1  
$EndComp
$Comp
...
U 5 1 616E5BD8
P 3625 4275
F 0 "U40" H 3583 4321 50  0001 L CNN
F 1 "MCP6004" H 3583 4275 50  0001 L CNN
F 2 "TSI_Rev_2021_Footprint_Lib:SOIC127P600X175-14N" H 3575 4375 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74hc00" H 3675 4475 50  0001 C CNN
	5    3625 4275
	1    0    0    -1  
$EndComp
Text Label 3525 3975 0    50   ~ 0
5HV
Text Notes 2400 4475 0    47   ~ 0
95% of \nVoltage
Text Notes 1775 4575 2    55   ~ 0
Buffer\n
Text Notes 1975 5700 2    55   ~ 0
Buffer\n
Text Label 1300 4900 0    79   ~ 0
IO_Ground
Wire Wire Line
	2375 4900 2275 4900
$Comp
...
U 1 1 616E5BCB
P 2125 4900
F 0 "R72" V 2025 4825 50  0000 L CNN
F 1 "95K" V 2125 4825 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 2055 4900 50  0001 C CNN
F 3 "~" H 2125 4900 50  0001 C CNN
	1    2125 4900
	0    -1   -1   0   
$EndComp
Text Label 575  5200 0    79   ~ 0
MC_Voltage
...
F 0 "U21" H 1675 4175 50  0000 C CNN
F 1 "MCP6004" H 1875 4025 50  0000 C CNN
F 2 "TSI_Rev_2021_Footprint_Lib:SOIC127P600X175-14N" H 1675 4275 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74hc00" H 1775 4375 50  0001 C CNN
	3    1725 4175
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "U21" H 1675 5300 50  0000 C CNN
F 1 "MCP6004" H 1875 5150 50  0000 C CNN
F 2 "TSI_Rev_2021_Footprint_Lib:SOIC127P600X175-14N" H 1675 5400 50  0001 C CNN
F 3 "http://www.ti.com/lit/gpn/sn74hc00" H 1775 5500 50  0001 C CNN
	4    1725 5300
	1    0    0    -1  
$EndComp
...
F 1 "TSV_Ready" H 5150 5025 50  0001 L CNN
...
U 1 1 616E5BC0
P 2375 4575
F 0 "RV1" H 2325 4575 50  0000 R CNN
F 1 "3296W-1-103LF" H 2305 4530 50  0001 R CNN
F 2 "Potentiometer_THT:Potentiometer_Bourns_3296W_Vertical" H 2375 4575 50  0001 C CNN
...
Wire Notes Line
	2750 4750 4300 4750
Text Notes 3000 4875 0    59   ~ 0
MC Voltage 95% Check
Connection ~ 5500 5000
Connection ~ 5725 5200
Text Notes 7350 4075 0    197  ~ 0
...
F 0 "TP19" H 13875 6675 50  0000 L CNN
F 1 "PC_Control" H 13950 6525 50  0001 L CNN
F 2 "TestPoint:TestPoint_Pad_D3.0mm" H 14125 6475 50  0001 C CNN
F 3 "~" H 14125 6475 50  0001 C CNN
	1    13925 6475
	1    0    0    -1  
$EndComp
Wire Wire Line
	13925 6475 13925 6625
Wire Bus Line
	14400 4050 14400 4250
Wire Bus Line
	12900 4050 12900 4250
Wire Bus Line
	14400 4250 14400 4850
Connection ~ 14400 4250
Wire Bus Line
	12900 4250 12900 4850
Connection ~ 12900 4250
Text Notes 14150 4525 0    79   ~ 0
0\n
Text Notes 13750 4825 0    79   ~ 0
X
Text Notes 13825 4375 2    79   ~ 0
X
Wire Notes Line
	12900 4700 14400 4700
Wire Notes Line
	12900 4550 14400 4550
Wire Notes Line
	12900 4400 14400 4400
Wire Bus Line
	14400 4250 12900 4250
Wire Bus Line
	14000 4850 14400 4850
Wire Bus Line
	14000 4050 14000 4850
Connection ~ 14000 4850
Connection ~ 14000 4050
Text Notes 14150 4375 0    79   ~ 0
X
Text Notes 14150 4825 0    79   ~ 0
X
Text Notes 14150 4675 0    79   ~ 0
1
Wire Bus Line
	14400 4050 14000 4050
Text Notes 14150 4225 0    79   ~ 0
~Q\n
Text Notes 13100 4000 0    79   ~ 0
SR Latching Logic\n
Wire Bus Line
...
Text Notes 13750 4675 0    79   ~ 0
0
Text Notes 13750 4525 0    79   ~ 0
1\n
Text Notes 13350 4525 0    79   ~ 0
1\n
Text Notes 13000 4825 0    79   ~ 0
1\n
Text Notes 13000 4675 0    79   ~ 0
1\n
Text Notes 13350 4825 0    79   ~ 0
1\n
Text Notes 13350 4375 0    79   ~ 0
0
Text Notes 13350 4675 0    79   ~ 0
0
Text Notes 13000 4525 0    79   ~ 0
0
Text Notes 13000 4375 0    79   ~ 0
0
Wire Bus Line
...
Wire Bus Line
	13200 4050 13200 4850
Wire Bus Line
	12900 4850 13200 4850
Wire Bus Line
	14000 4050 13600 4050
Text Notes 13750 4225 0    79   ~ 0
Q\n
Text Notes 13350 4225 0    79   ~ 0
~R\n
...
F 0 "R117" V 5025 5800 50  0000 C CNN
F 1 "2.4K" V 5100 5800 50  0000 C CNN
...
F 0 "D17" V 5139 6057 50  0000 R CNN
F 1 "GREEN LED" V 5048 6057 50  0001 R CNN
F 2 "LED_SMD:LED_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 5100 6175 50  0001 C CNN
F 3 "http://static.vcclite.com/pdf/VAOL-S8GT4-LED-0805-green.pdf" H 5100 6175 50  0001 C CNN
F 4 "VAOL-S8GT4" V 5100 6175 50  0001 C CNN "Part Name"
	1    5100 6175
	0    -1   -1   0   
$EndComp
$Comp
...
F 0 "R116" V 4750 5800 50  0000 C CNN
F 1 "2.4K" V 4825 5800 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 4755 5800 50  0001 C CNN
F 3 "~" H 4825 5800 50  0001 C CNN
	1    4825 5800
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "D16" V 4925 6325 50  0000 R CNN
F 1 "GREEN LED" V 4773 6057 50  0001 R CNN
F 2 "LED_SMD:LED_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 4825 6175 50  0001 C CNN
F 3 "http://static.vcclite.com/pdf/VAOL-S8GT4-LED-0805-green.pdf" H 4825 6175 50  0001 C CNN
F 4 "VAOL-S8GT4" V 4825 6175 50  0001 C CNN "Part Name"
	1    4825 6175
	0    -1   -1   0   
$EndComp
Wire Wire Line
...
F 0 "R115" V 4475 5800 50  0000 C CNN
F 1 "2.4K" V 4575 5800 50  0000 C CNN
F 2 "Resistor_SMD:R_0805_2012Metric_Pad1.15x1.40mm_HandSolder" V 4505 5800 50  0001 C CNN
...
F 0 "D15" V 4675 6325 50  0000 R CNN
F 1 "GREEN LED" V 4523 6057 50  0001 R CNN
F 2 "LED_SMD:LED_0805_2012Metric_Pad1.15x1.40mm_HandSolder" H 4575 6175 50  0001 C CNN
F 3 "http://static.vcclite.com/pdf/VAOL-S8GT4-LED-0805-green.pdf" H 4575 6175 50  0001 C CNN
F 4 "VAOL-S8GT4" V 4575 6175 50  0001 C CNN "Part Name"
	1    4575 6175
	0    -1   -1   0   
$EndComp
Wire Wire Line
